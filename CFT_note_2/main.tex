...
\title{\boldmath Advanced Theory of CFT}
\author{X. D. H.}
...
\begin{abstract}
这个是笔记，我希望重新学习CFT。但是从更加advanced的视角进行学习。一个是学习比较先进的和代数和category的关系；还有一个是学习和几何以及引力的关系；还有关于TQFT的内容。
\end{abstract}
